  ...
  <div class="phone">
    <div class="phone_border">
      <div class="phone_headerBar p_r">
        <div class="front_lamp p_a circle " :class="{
      ...
      <div class="phone_screen bg_b"
           :class="{'startup_screenPic':screenPic.startupPic,'shutdown_screenPic':screenPic.shutdownPic}">
    ...
    methods: {
      ...
      getStartupAnimation: function () {
        ...
        let inter = setInterval(function () {
          ct.beginPath();
          ct.arc(screenCanvas.width / 2, 100, 50, 0, cnt);
          ct.stroke();
          ct.closePath();
          if (cnt.toFixed(2) === (2 * Math.PI).toFixed(2)) {
            clearInterval(inter);
